...
gpp_results <- tibble(
  ...
  Rs2 = rnorm(n = n_samp, mean = 80.4, sd = 16.9), # for those with standard deviation, n_samp samples were take from normal distribution ~ (mean=80.4, sd=16.9)
  ...
  gpp1 = rnorm(n = n_samp, mean = 124.6, sd = 2.7), # if gpp have mean and standard deviation, take n_samp samples from the normal distribution
  ...
  gpp9 = rnorm(n = n_samp, mean = 119, sd = 6),
  gpp10 = rnorm(n = n_samp, mean = 122, sd = 25),
  ...
  Rc_agr = sample(var_agr_rc$RC_annual, n_samp, replace = TRUE),
  # forest further separate into 3 groups
  Rc_df = sample(var_df_rc$RC_annual, n_samp, replace = TRUE),
  Rc_ef = sample(var_ef_rc$RC_annual, n_samp, replace = TRUE),
  Rc_mf = sample(var_mf_rc$RC_annual, n_samp, replace = TRUE), 
  # other ecosystems
  Rc_gra = sample(var_gra_rc$RC_annual, n_samp, replace = TRUE),
  Rc_shr = sample(var_shr_rc$RC_annual, n_samp, replace = TRUE),
...
rs_results <- tibble(
  ...
  gpp9 = rnorm(n = n_samp, mean = 119, sd = 6),
  gpp10 = rnorm(n = n_samp, mean = 122, sd = 25),
  # for those do not have SD information, take samples using boosting 
  gpp11 = sample(var_GPP, n_samp, replace = TRUE), 
