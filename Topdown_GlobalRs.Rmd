...
pairsdata <- rename(pairsdata, 'Canonical-Rs' = Rs_raw, 'Rroot-to-Rs ratio' = Rc, 'Rroot-to-Ra ratio' = Froot)
pdf("outputs/Figure S9 - Boots GPP pairs.pdf", width = 8, height = 6)
...
pairsdata <- rename(pairsdata, 'Canonical-GPP' = GPP_raw, 'Rroot-to-Ra ratio' = Froot_rest,'Ra-to-GPP ratio' = RaGpp_rest)
pdf("outputs/Figure S10 - Boots Rs pairs.pdf", width = 8, height = 6)
...
p_joint <- ggplot(joint, aes(GPP, Rs, color = Source)) + 
  ...
  scale_color_discrete("", labels = c(expression(Canonical~GPP~and~R[S]~implied~by~GPP), 
                                      expression(Canonical~R[S]~and~GPP~implied~by~R[S]))) +
