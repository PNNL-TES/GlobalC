...
* 1. Introduction
```{r plot sites spatial destribution}
...
### Sematio 2 - ratio weighted by ecosystem
```{r}
# senario 2
...
### Scenario 1 - ratio not weighted by ecosystem
```{r plot RSG results}
# mean(rs_results$Rs)
# max(rs_results$Rs)
...
### Scenario 2 - ratio not weighted by ecosystem
```{r}
