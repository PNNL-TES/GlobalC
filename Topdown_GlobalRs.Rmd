...
print(p_joint)
# ggsave("outputs/Figure2.png", width = 8, height = 6)
...
```{r Rh-to-GPP ratio}
# global Rh from Hashimoto2015, Zhao2017, Warner2019, Konings2019(43.6, 33.4)
topdown_rh <- expand.grid(GPP = GPP$GPP, Rh = c(50.5, 59.5, 49.7, 43.6, 57.2))
...
fluxnet_Rh$Scale <- "Ecosystem scale"
