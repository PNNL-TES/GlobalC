...
# get mean Rroot:Rs, NPP, GPP[lit] of below of above the intercetion (78.11 Pg)
rs_results %>%
...
p_joint <- ggplot(joint, aes(GPP, Rs, color = Source)) +
  ...
  annotate("text",
    x = c(105, 151), y = 47.5, size = 4, hjust = "inward", fontface = "bold",
    label = c(expression(GPP[Lit]), expression(GPP[Rs]))
  ) +
  annotate("text",
    x = 70, y = c(65, 85), size = 4, hjust = "inward", fontface = "bold",
