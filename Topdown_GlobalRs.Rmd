...
cmip6_global_data_file <- "data/CMIP/1.cmip6_global_monthly_means.csv"
if(file.exists(cmip6_global_data_file)) {
  ...
  model_global_data %>% 
    ...
    summarise(variable = "Rs", 
              value = sum(value)) %>% 
    bind_rows(filter(model_global_data, variable == "gpp")) %>% 
...
cmip6_local_data_file <- "data/CMIP/1.cmip6_local_annual_means.csv"
