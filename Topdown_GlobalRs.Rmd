...
p1_gpp <- ggdraw() +
  ...
  draw_plot(p_gpp_marg, x = 0.35, y = 0.4, width = 0.4, height = 0.5)
print(p1_gpp)
...
p2_rs <- ggdraw() +
  ...
  draw_plot(p_rs_marg, x = 0.1, y = 0.4, width = 0.4, height = 0.5)
print(p2_rs)
...
ggsave("outputs/Figure1.png") # , width = 10, height = 8, dpi = 300, units = "in"
```
