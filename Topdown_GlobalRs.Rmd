...
bootstrap_data <- tibble(Rs_raw = replace_SD_and_generate2(GlobalRs$Rs, GlobalRs$SD),
                         GPP_raw = replace_SD_and_generate2(GPP$GPP, GPP$SD))
...
bootstrap_data %>% 
  mutate(
    ...
    Fire = replace_SD_and_generate2(var_Fire$Amount_Pg, var_Fire$SD), # Another way to do fire resample (use mean and SD)
