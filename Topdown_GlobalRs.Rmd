...
# pdf("outputs/FigureS8 - Boots GPP pairs.pdf", width = 8, height = 6)
...
# pdf("outputs/FigureS9 - Boots Rs pairs.pdf", width = 8, height = 6)
...
# ggsave("outputs/FigureS7.1.png", width = 9, height = 8)
...
# ggsave("outputs/FigureS7.2.png", width = 6, height = 4)
```
...
print(p_joint)
# ggsave("outputs/Figure2.png", width = 8, height = 8)
...
# ggsave("outputs/FigureS7.jpg", width = 8, height = 6, dpi = 300, units = "in")
```
