...
gpp_qt <- quantile(gpp_simple_results$GPP, c(0.025, 0.5, 0.975)) %>% round(0)
gpp_qt_raw <- quantile(gpp_simple_results$GPP_raw, c(0.025, 0.5, 0.975)) %>% round(0)
...
p_gpp3 <- prob_agreement(gpp_simple_results$GPP, gpp_qt_raw)
print(paste0("The probability of agreement in scenario 2 is: ", p_gpp3))
```
