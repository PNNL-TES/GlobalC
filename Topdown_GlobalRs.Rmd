...
gpp_results %>% ggplot() + aes(GPP) + 
  ...
  annotate("text", x = 150, y = 0.035, 
           label = paste0("2.5%, 50%, 97.5% quantile (", gpp_qt[1],", ", gpp_qt[2], ", ", gpp_qt[3], ")"), 
           hjust = 0, 
           col = rgb(1, 0, 1)) +
  annotate("text", x = 150, y = 0.025, 
           label = paste0("2.5%,50%,97.5% quantile (", gpp_qt_raw[1],", ", gpp_qt_raw[2], ", ", gpp_qt_raw[3], ")"), 
           hjust = 0, 
           col = rgb(0, 1, 1)) +
