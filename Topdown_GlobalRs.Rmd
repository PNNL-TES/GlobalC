...
var_wet_froot <- Froot[Froot$Ecosystem == "Wetland",]$Froot #  agriculture
...
p1_gpp <- annotations(gpp_base_figure, 
                      unique(gpp_figure_data$GPP_type), 
...
p1_gpp2 <- annotations(gpp_base_figure %+% gpp_figure2_data,
                       unique(gpp_figure2_data$GPP_type),
                       gpp_qt, gpp_qt_raw, 150)
print(p1_gpp2)
```
...
p1_gpp3 <- annotations(gpp_base_figure %+% gpp_ratio_figure_data,
...
p2_rs <- annotations(rs_base_figure, 
                     types = unique(rs_figure_data$Rs_type), 
                     rsg_qt, rsg_qt_raw, 100)
print(p2_rs)
